...
r=function(){dpi=window.devicePixelRatio;var a='data-src'; if($('.js4 .slide0').hasAttr('src')) { a='src'; } $('.js4 .slide0').attr(a, (dpi>1) ? 'images/example-844.png' : 'images/example-422.png');
var a='data-src'; if($('.js4 .slide1').hasAttr('src')) { a='src'; } $('.js4 .slide1').attr(a, (dpi>1) ? 'images/example1-844.png' : 'images/example1-422.png');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(){$(this).click(function(){var t=this.hash.length>1?$('[name="'+this.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
plyr.setup(document.querySelectorAll('.player video'));
if($('.js video')[0].plyr.volume){$('.js video')[0].plyr.setVolume(0);}
$('.js video')[0].plyr.play();
